...
func (p *EchoServiceClient) Echo(ctx context.Context, request *Request) (r *Response, err error) {
...
var EchoServiceEchoArgs_Request_DEFAULT *Request

func (p *EchoServiceEchoArgs) GetRequest() (v *Request) {
	if !p.IsSetRequest() {
		return EchoServiceEchoArgs_Request_DEFAULT
	}
	return p.Request
}
func (p *EchoServiceEchoArgs) SetRequest(val *Request) {
	p.Request = val
}
...
func (p *EchoServiceEchoArgs) Field1DeepEqual(src *Request) bool {
...
func (p *EchoServiceEchoResult) Field0DeepEqual(src *Response) bool {
